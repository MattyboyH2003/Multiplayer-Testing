...
result = http.request("GET", f"http://192.168.1.142:6900/JoinServer/{serverID}/{serverPass}")
...
if result:
    ...
    while True:
        ...
        print(http.request("GET", f"http://192.168.1.142:6900/SendInfo/{serverID}/{serverPass}/{localID}/{localPass}/{info}").data.decode("utf-8"))
